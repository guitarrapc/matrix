...
name: matrix bloom
author: matrix
description: Green-tinted bloom for the matrix CLI rain effect
version: 1.0.0
 defaults:
 animation_speed: 0.5
 full_content: true
 ...
 uniforms:
 iBaseOpacity: 1.0
 iBloomIntensity: 1.15
 iBloomKnee: 0.08
 iBloomRadius: 1.2
 iBloomSaturation: 1.2
 iBloomThreshold: 0.18
 iBloomTint: '#30FF58'
*/

// Adapted from par-term bloom.glsl (qwerasd205 / Ghostty gist)
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
 ...
 vec3 color = base.rgb * iBaseOpacity + bloom.rgb * iBloomIntensity;
 // Full-content shaders must output opaque alpha or the compositor drops the layer.
